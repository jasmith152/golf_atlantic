...
<head>
  ...
  <meta name="description" content="GreyStone inclined single-spiral fine material washer initially dewaters the material while the rotation of the dewatering screw scrubs it to remove surface dirt." />
  <title>GreyStone Aggre-Dry Washer sand dewatering unit combines a fine material screw and dewatering screen.</title>
<?php
...
<?php
$file_contents = file_get_contents('content/product-spotlight1.txt');
