 ...
 <table id="content" width="960" cellpadding="0" cellspacing="0" border="0">
  <tr>
   <td align="left" valign="top" id="main-col">
    <p align="left"><img src="images/page-sep.jpg" alt="" height="32" width="912" align="top" border="0" /></p>
    <a name="top"></a>
    <p align="left">Logo</p>
    Content
    ...
    <div align="center">
     <hr width="70%" />
     <font size="3" face="Arial, Helvetica, sans serif"><strong>For more information or to receive a quotation on Command Alkon, <a href="mailto:info@gulfatlanticequipment.com" target="_blank">click here</a></strong></font><br />
     <hr width="70%" />
    </div>
   </td>
  </tr>
