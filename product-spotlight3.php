...
<head>
  ...
  <meta name="description" content="The VersaCap impact crusher is the most versatile impact crusher on the market with interchangeable components to custom fit your specific application." />
  <title>Universal VersaCap primary impact crusher with interchangeable components to "custom fit" your specific application.</title>
<?php
...
<?php
$file_contents = file_get_contents('content/product-spotlight3.txt');
