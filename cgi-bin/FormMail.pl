...
BEGIN
{
  ...
  @referers          = qw(gulfatlanticequipment.com 50.28.18.106 localhost);
  @allow_mail_to     = qw(info@gulfatlanticequipment.com parts@gulfatlanticequipment.com webadmin@naturecoastdesign.net localhost);
  @recipients        = ();
  %recipient_alias   = ();
